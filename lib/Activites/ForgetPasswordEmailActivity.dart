...
class ForgetPasswordEmail extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return new ForgetPasswordEmailClickLiser();
  }
}

class ForgetPasswordEmailClickLiser extends State<ForgetPasswordEmail> {
  String MyName = '';
  String name = '';
                          ...
                          children: <Widget>[
                            ...
                            new Column(
                              ...
                              children: <Widget>[
                                ...
                                new Padding(padding: EdgeInsets.all(10.0)),
                                new Text(Flutkart.ForgetpasswordEmail,
                                  maxLines: 2,
                                ...
                                new InkWell(
                                  onTap: ()=> Navigator.of(context).pushNamed('/ForgetPasswordCode'),
                                  child: new Container(
                                    width: 200,
                                    height: 35,
                                    decoration: new BoxDecoration(
